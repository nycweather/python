...
#Step 2 fuction that will take marker for player 1    
def player_input():
    marker=''
...
#step 3 board postion for player input and assignment
...
#step 5 see who gets to go first
def choose_first():
...
#step 6 if the board has a empty slot
def space_check(board, position):
  return board[position] in range(0,10)


  
#step 7 checks if board is full
...
#step 8 ask for players next position and recall it to step 6 to check for position
